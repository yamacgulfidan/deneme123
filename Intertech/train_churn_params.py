...
parser.add_argument('--account_name', dest="account_name", required=True)
args = parser.parse_args()



## Data Lake GEN2 account'umuza bağlanıyoruz
block_blob_service = BlockBlobService(account_name = args.account_name, account_key = 'RVg8vNu4rddB86M6G38qnpi2MzTBv9JGxbAgixEQHUSJtrlBtItQraAN7OVzAlm0EbqWQEsv9eO3k4BdZ34flA==')
...
exp = Experiment(workspace=ws, name="exp10")
